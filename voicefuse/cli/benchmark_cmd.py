...
def _generate_markdown_report(report: dict, path: str):
    ...
    lines = [
        ...
        f"**Generated by:** [VoiceFuse](https://github.com/daewook/voicefuse) `voicefuse benchmark`",
        "",
        "---",
        "",
        "## Results",
    ...
    lines.extend([
        ...
        "---",
        "",
        "*Generated with [VoiceFuse](https://github.com/daewook/voicefuse) - LiteLLM for Voice*",
    ])
